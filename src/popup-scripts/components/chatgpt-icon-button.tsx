...
export const ChatGPTIconButton: React.FC<Props> = ({ isSelected, onClick }) => {
  return (
    <IconButton
      tooltip="ChatGPT"
    ...
    >
      <svg
        ...
        viewBox="0 0 64 64"
        className={cn(
          "size-6 group-hover:scale-[1.2] group-active:scale-[1.1] dark:brightness-70 group-hover:grayscale-0 duration-400 ease-out-overshoot-soft",
          {
            "dark:brightness-[1.05]": isSelected,
            "grayscale dark:group-hover:brightness-90": !isSelected,
          },
        )}
      >
        <title>ChatGPT</title>
