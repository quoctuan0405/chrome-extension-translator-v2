...
export const GeminiIconButton: React.FC<Props> = ({ isSelected, onClick }) => {
  return (
    <IconButton
      tooltip="Gemini"
    ...
    >
      <svg
        ...
        className={cn(
          "size-6 group-hover:scale-[1.3] group-active:scale-[1.15] dark:brightness-95 group-hover:grayscale-0 duration-400 ease-out-overshoot-soft",
          {
            "dark:brightness-125": isSelected,
